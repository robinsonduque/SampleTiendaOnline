...
SECRET_KEY = "@p*!1fvn1_m02k3w3xz44q^hgl^+g8e3bwh*4g@a-5(k(u=ern"
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "carro.context_processors.totalProductos",  # se agregó este context para el carro
            ],
        },
    },
]
...
# Incluido para manejo de mensajes con Bootstrap
MESSAGE_TAGS = {
